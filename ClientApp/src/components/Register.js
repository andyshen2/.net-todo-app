...
class Register extends Component {
  ...
  handleChange = (event) => {
    ...
    switch (name) {
      case "firstName":
        errors.firstname = value.length < 1 ? "First name cannot be empty" : "";
        break;
      case "lastName":
        errors.lastname = value.length < 1 ? "Last name can not be empty" : "";
        break;
      case "username":
        errors.username = value.length < 1 ? "Username can not be empty" : "";
        break;
      case "password":
        errors.password = value.length < 1 ? "Password can not be empty" : "";
